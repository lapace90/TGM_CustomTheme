          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              {if $cart.subtotals.shipping.value}
                <p><span class="shipping">{l s='Shipping:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="shipping value">{$cart.subtotals.shipping.value} {hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</span></p>
              {/if}
